...
import { SuperAdminMenuSections } from "@/constants";
...
export default function SuperAdminSidebar({
  ...
  return (
    ...
    >
      ...
      <nav className="flex-1 overflow-y-auto overflow-x-hidden py-4 h-[calc(100dvh-200px)]">
        {SuperAdminMenuSections.map((section, sectionIndex) => (
